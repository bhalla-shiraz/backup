 ...
 */
 ...
 var stateDimension = ndx.dimension(function(d) {
...
//groups
 ...
 var sessionsPerState = stateDimension.group().reduceSum(function(d) {
  return d.numberOfSession;
 });

 var sessionsPlacedGroup = stateDimension.group().reduceSum(function(d) {
  if(d.orderId != null ){
   return d.numberOfSession;
  }
  else{
 ...
 var sessionsNotPlacedGroup = stateDimension.group().reduceSum(function(d) {
  if(d.orderId == null ){
   return d.numberOfSession;
  }
  else{
 ...
 var eventDimension = ndxEvent.dimension(function(d) {
  return [+d.time, +maxSessionsPerdate/2];
 });
